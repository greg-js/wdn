...
#           clear, rm-all, remove-all, show, s, clean, x, ssh
if [[ $1 =~ ^\-?\-?help$ || $1 =~ ^\-?\-?h$ || $1 =~ ^\-?\-?version$ || $1 =~ ^\-?\-?v$ || $1 =~ ^\-?\-?list$ || $1 =~ ^\-?\-?ls$ || $1 =~ ^\-?\-?add$ || $1 =~ ^\-?\-?a$ || $1 =~ ^\-?\-?remove$ || $1 =~ ^\-?\-?rm$ || $1 =~ ^\-?\-?clear$ || $1 =~ ^\-?\-?rm\-all$ || $1 =~ ^\-?\-?remove\-all$ || $1 =~ ^\-?\-?show$ || $1 =~ ^\-?\-?s$ || $1 =~ ^\-?\-?clean$ || $1 =~ ^\-?\-?x$ || $1 =~ ^\-?\-?ssh$ ]]; then
  node ${WD}/cli.js $@
